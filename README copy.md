...
ln -s `pwd`/dist ~/.local/share/cockpit/backblaze-b2
```
...
your project after forking from backblaze-b2.
 ...
 * The [Starter Kit announcement](https://cockpit-project.org/blog/backblaze-b2.html)
